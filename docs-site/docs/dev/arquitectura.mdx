...
* **[Frontend](https://github.com/MVRU/conectando-corazones/tree/main/frontend):** [SvelteKit 5](https://kit.svelte.dev/docs) + [Tailwind CSS 4.1.7](https://tailwindcss.com/docs).
