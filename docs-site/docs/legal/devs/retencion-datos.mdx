...
* Los registros de `HistorialCambios` se purgan automáticamente a los **6 meses** del cierre del proyecto.
...
{/* ! Corregir siguiendo estructura de tabla HistorialCambios */}

### Ejemplo de registro de HistorialCambios
...
```json
{
  ...
  "proyectoId": 123,
  "evidenciaId": 456,
  "motivo": "Solicitud de la institución",
