...
- No se almacenarán datos sensibles como CUIL/CUIT ni números de documento en la base de datos.
    ...
    - **Ley 25.326:** política de privacidad clara, finalidades, derechos del titular; y registrar la base de datos ante [AAIP](https://www.argentina.gob.ar/aaip/datospersonales/tramites?utm_source=chatgpt.com).
