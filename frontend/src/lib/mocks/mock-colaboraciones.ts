...
export const mockColaboraciones: Colaboracion[] = [
    ...
    },
    {
        id_colaboracion: 10,
        estado: 'pendiente',
        mensaje: 'Como biblioteca popular, tenemos muchos libros infantiles que podríamos donar y experiencia organizando actividades de lectura para niños.',
        created_at: new Date('2025-03-10'),
        proyecto_id: 2,
        colaborador_id: 5,
    ...
    },
    {
        id_colaboracion: 11,
        estado: 'pendiente',
        mensaje: 'Nuestra fundación tiene amplia experiencia en proyectos educativos y podemos aportar recursos humanos, materiales didácticos y voluntarios especializados.',
    ...
    },
    {
        id_colaboracion: 12,
        estado: 'pendiente',
        mensaje: 'Como parte de nuestra responsabilidad social empresaria, queremos apoyar la educación infantil con donaciones económicas y voluntarios de nuestro equipo.',
    ...
    },
    {
        id_colaboracion: 13,
        estado: 'pendiente',
        mensaje: 'Soy docente jubilada y me encantaría colaborar con mi experiencia pedagógica. Puedo ayudar con clases de apoyo y actividades recreativas.',
    ...
    },
    {
        id_colaboracion: 14,
        estado: 'pendiente', 
        mensaje: 'Tengo experiencia en trabajo comunitario y me gustaría aportar tiempo de voluntariado los fines de semana para ayudar con las actividades del proyecto.',
    ...
    },
    {
        id_colaboracion: 15,
        estado: 'aprobada',
        mensaje: 'Nuestra fundación tiene amplia experiencia en proyectos educativos y podemos aportar recursos humanos y materiales.',
        created_at: new Date('2025-02-28'),
        proyecto_id: 6,
        colaborador_id: 6,
        colaborador: getColaborador(6) // fundacion_manos_unidas
    },
    {
        id_colaboracion: 16,
        estado: 'pendiente',
        mensaje: 'Como empresa comprometida con la RSE, queremos apoyar la educación con donaciones y voluntarios corporativos.',
    ...
    // Colaboraciones para proyecto 2
    {
        id_colaboracion: 17,
        estado: 'pendiente',
        mensaje: 'Podemos donar alimentos no perecederos y coordinar jornadas de voluntariado para ayudar con la alimentación.',
...

    {
        ...
        justificacion: 'El mensaje es muy genérico y no especifica cómo puede contribuir al proyecto específico.',
    ...
    },
    {
        ...
        justificacion: 'No cumple con los requisitos de transparencia financiera solicitados en las bases del proyecto.',
    ...
    },
    {
        ...
        justificacion: 'La disponibilidad ofrecida no se ajusta a los horarios requeridos por el proyecto.',
