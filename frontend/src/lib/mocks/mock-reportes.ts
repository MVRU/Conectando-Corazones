...
export const mockReportes: Reporte[] = [
    ...
    },
    {
        ...
        descripcion: 'El proyecto no muestra actualizaciones desde hace mucho tiempo y no responden mensajes.',
    ...
    },
    {
        ...
        comentario_resolucion: 'Usuario investigado y advertido. Se han dado de baja los proyectos duplicados.',
        reportante_id: 2,
        admin_id: 1
    },
    {
        ...
        comentario_resolucion: 'Hemos verificado la autenticidad de las imágenes con metadatos y visitas en terreno. El reporte es inválido.',
        reportante_id: 2,
        admin_id: 1
    },
    {
