...
<form on:submit={handleSubmit} class="mx-auto max-w-4xl space-y-10">
	...
	{#if tipo === 'persona'}
		<fieldset class="grid grid-cols-1 gap-6 md:grid-cols-2">
			...
			<div>
				...
				<Input id="apellido" bind:value={apellido} error={intentoEnvio ? errores.apellido : ''} />
			</div>
			...
			{#if docTipo === 'Otro'}
				<div>
					...
					<Input id="docOtro" bind:value={docOtro} error={intentoEnvio ? errores.docOtro : ''} />
				</div>
			{/if}
			...
			<div>
				...
				<Input
					...
					error={intentoEnvio ? errores.docNumero : ''}
				/>
			</div>
			...
			<div>
				...
				<DatePicker
					...
					error={intentoEnvio ? errores.nacimiento : ''}
				/>
			</div>
			...
			<div>
				...
				<Input
					id="cuil"
					bind:value={cuil}
					error={intentoEnvio ? errores.cuil : ''}
					maskCuil={true}
				/>
			</div>
		</fieldset>
		...
		<fieldset class="grid grid-cols-1 gap-6 md:grid-cols-2">
			<div class="md:col-span-2">
				...
				<Input
					...
					error={intentoEnvio ? errores.razonSocial : ''}
				/>
			</div>
	...
	<div class="grid grid-cols-1 gap-6 md:grid-cols-2">
		<div>
			...
			<Input id="username" bind:value={username} error={intentoEnvio ? errores.username : ''} />
		</div>
		...
		<div>
			...
			<Input id="email" type="email" bind:value={email} error={intentoEnvio ? errores.email : ''} />
		</div>
		...
		<div class="relative">
			...
			<Input
				...
				customClass="mt-1 w-full rounded-xl border border-gray-200 bg-white px-4 py-2 text-base text-black placeholder-gray-400 transition focus:border-blue-400 focus:ring-2 focus:ring-blue-300"
				placeholder="********"
				error={intentoEnvio ? errores.repassword : ''}
			/>
			<button
				type="button"
				class="absolute top-9 right-3 flex h-6 w-6 items-center justify-center focus:outline-none"
