...
* Props:
	-*- Ninguna explícita por ahora (contenidos estáticos).
...
<script lang="ts">
	...
	onMount(() => {
		...
		setTimeout(() => (showImages = true), 300);
	});
</script>

<section class="w-full bg-[rgb(var(--base-color))] px-4 py-20 text-white md:px-8">
