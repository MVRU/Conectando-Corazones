...
<footer class="bg-base-color w-full py-12 text-white">
	<div class="mx-auto max-w-7xl px-6">
		<div class="grid grid-cols-1 gap-12 md:grid-cols-3 md:gap-x-20">
			...
			<!-- Sección Enlaces -->
			<nav class="md:pl-15 flex flex-col space-y-2">
				...
				<a
					href="/donate"
					class="opacity-80 transition-opacity duration-300 ease-in-out hover:opacity-100">Donar</a
				>
				<a
					href="/projects"
					class="opacity-80 transition-opacity duration-300 ease-in-out hover:opacity-100"
		...
		<div class=" flex flex-row items-center justify-between gap-4">
			...
			<nav aria-label="Soporte" class="flex flex-row gap-6 text-sm">
				<a
					href="/faq"
					class="opacity-70 transition-opacity duration-300 ease-in-out hover:opacity-100"
					>Preguntas Frecuentas</a
				>
				<a
					href="/privacy"
					class="opacity-70 transition-opacity duration-300 ease-in-out hover:opacity-100"
