...
<div class="rounded-lg border border-gray-200 bg-white p-3 transition-shadow hover:shadow-sm">
	...
	<div class="flex items-start gap-3">
		...
		<div class="flex-1 min-w-0">
			<p class="text-sm font-medium text-gray-900 truncate" title={archivo.descripcion}>
			...
			<div class="mt-2 flex items-center gap-2">
				{#if esImagenArchivo || esPDFArchivo}
					<button
						...
						class="inline-flex items-center gap-1.5 rounded-md px-2.5 py-1 text-xs font-medium text-blue-600 transition-colors hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-1"
					>
				...
				<button
					...
					class="inline-flex items-center gap-1.5 rounded-md px-2.5 py-1 text-xs font-medium text-gray-700 transition-colors hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-1"
				>
					<svg class="h-3.5 w-3.5" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
