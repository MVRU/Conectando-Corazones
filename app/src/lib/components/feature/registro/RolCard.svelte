...
<div
	...
	class={clsx(
		...
		seleccionado
			? 'border-[rgb(var(--color-primary))] bg-blue-50/10 shadow-2xl ring-1 shadow-blue-500/10 ring-[rgb(var(--color-primary))]/30'
...
>
	...
	<div
		class={clsx(
			...
			seleccionado
				...
				: 'border border-slate-100 bg-white text-slate-400 group-hover:border-[rgb(var(--color-primary))]/20 group-hover:text-[rgb(var(--color-primary))]'
		)}
	>
	...
	<div class="space-y-4 text-center">
		...
		<p class="line-clamp-3 text-base leading-relaxed text-slate-500">
			{descripcion}
		</p>
	</div>
	...
	<div class="mt-10 flex items-center gap-2">
		<span
			class={clsx(
				...
				seleccionado
					? 'scale-110 text-[rgb(var(--color-primary))]'
		...
		<div
			class={clsx(
				...
				seleccionado
					? 'scale-150 bg-[rgb(var(--color-primary))]'
					: 'bg-slate-300 group-hover:bg-[rgb(var(--color-primary))]/40'
			)}
		></div>
	</div>
</div>
