<script lang="ts">
	...
	export let metrics: {
		...
		proximoCierre: number; // Days remaining
	};

	// Tweened stores for number animation
	...
	function handleReveal() {
		tProyectos.set(metrics.proyectosActivos);
		tColaboradores.set(metrics.colaboradores);
		tCierre.set(metrics.proximoCierre);
	}
</script>
...
<div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
	...
	<div
		...
		class="reveal-hidden group relative overflow-hidden rounded-[2rem] border border-emerald-500/20 bg-emerald-500/10 p-6 backdrop-blur-md transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-emerald-500/10"
	>
		<div
	...
	<div
		use:reveal={{ threshold: 0.2 }}
		class="reveal-hidden group relative overflow-hidden rounded-[2rem] border border-blue-500/20 bg-blue-500/10 p-6 backdrop-blur-md transition-all delay-100 duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-blue-500/10"
	>
		<div
	...
	<div
		use:reveal={{ threshold: 0.2 }}
		class="reveal-hidden group relative overflow-hidden rounded-[2rem] border border-amber-500/20 bg-amber-500/10 p-6 backdrop-blur-md transition-all delay-200 duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-amber-500/10"
	>
		<div
