...
import type { Step } from '$lib/domain/types/otros/Step';
...
export const steps: Step[] = [
	{
		...
		details:
			'Las instituciones pueden publicar problemáticas de interés social especificando las responsabilidades necesarias para que los colaboradores comprendan claramente cómo pueden ayudar.',
	...
	},
	{
		...
		details:
			'Cada proyecto incluye responsabilidades claras. Por ejemplo, si requerís voluntariado, especificá cuántos voluntarios necesitás. Si es una donación monetaria, indicá la cantidad exacta a recaudar.',
	...
	},
	{
		...
		details:
			'Los colaboradores interesados pueden explorar los proyectos publicados, filtrarlos según sus intereses y enviar solicitudes para ayudar. Elegí las responsabilidades que podés cumplir.',
	...
	},
	{
		...
		details:
			'Las instituciones revisan las postulaciones recibidas y deciden cuáles aceptar, asegurando que las colaboraciones sean las más adecuadas para el proyecto.',
	...
	},
	{
		...
		details:
			'Una vez aceptadas las postulaciones, los colaboradores acceden a un chat compartido con la institución y otros colaboradores. Coordiná esfuerzos y trabajá juntos para llevar el proyecto al éxito.',
